...
import { ArticleSectionVariants, CodeMinimizer } from "ui";
...
### Article <p className="text-sm font-normal inline-block">_(component wrapper)_</p>

<PropsCard
  name="ref"
  description="Forwarded Ref Attribute"
...
```tsx
<Article>
  <Article.Header date="" title=""></Article.Header>
  <Article.Description description="">
    <div></div>
    <div></div>
    <div></div>
